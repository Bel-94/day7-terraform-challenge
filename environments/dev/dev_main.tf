# Dev environment — cheapest instance type, relaxed security rules appropriate for development work.
...
output "subnet_id" {
  description = "Subnet ID — exposed so other configs can reference it"
